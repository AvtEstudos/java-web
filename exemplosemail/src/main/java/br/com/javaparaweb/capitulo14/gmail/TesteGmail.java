...
public class TesteGmail {
	...
	private static final String EMAIL = "andretamayoshi@gmail.com";
	private static final String SENHA = "Udemy840427";
	...
	public static void main(String[] args) throws AddressException, MessagingException {
		...
		email.setRecipient(Message.RecipientType.TO, new InternetAddress("andretamayoshi@gmail.com"));
