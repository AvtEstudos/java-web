...
import br.com.andre.financeiro.web.util.MensagemUtil;
...
public class ChequeBean {
	...
	public void salvar() {
		...
		if(this.chequeInicial == null || this.chequeFinal == null) {
			String texto = MensagemUtil.getMensagem("cheque_erro_sequencia"); //1
			context.addMessage(null, new FacesMessage(texto)); //2
