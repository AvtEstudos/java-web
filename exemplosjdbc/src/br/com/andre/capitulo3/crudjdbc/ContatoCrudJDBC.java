package br.com.andre.capitulo3.crudjdbc;
...
public class ContatoCrudJDBC {
	...
	public void atualizar(Contato contato) {
		...
		try {
			...
			try {
				...
				System.out.println("Erro ao fechar operações de atualização. Mensagem: "
						+ e.getMessage());
			}
		}
	}
	...
	public void excluir(Contato contato) {
		...
		try {
			...
			try {
				...
				System.out.println("Erro ao fechar operações de exclusão. Mensagem: "
						+ e.getMessage());
			}
		}		
	}	
	...
	public Connection geraConexao() {		
		...
		try {
			...
			System.out.println("Classe não encontrada. Erro: " 
					+ e.getMessage());
		} catch (SQLException e) {
	...
	public static void main(String[] args) {				
		...
		beltrano.setNome("Contato Um");
		beltrano.setTelefone("(47) 5555-3333");
		beltrano.setEmail("contato_um@teste.com.br");
		...
		beltrano = new Contato();
		beltrano.setNome("Contato Dois");
		beltrano.setTelefone("(47) 5555-3333");
		beltrano.setEmail("contato_dois@teste.com.br");
		beltrano.setDataCadastro(new Date(System.currentTimeMillis()));
		beltrano.setObservacao("Segundo cliente");
		contatoCrudJDBC.salvar(beltrano);
